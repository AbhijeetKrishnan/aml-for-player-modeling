(define (domain ../blackout/sokoban-sequential.pddl)
...
:effect (and (at-goal ?1stone) (at ?1stone ?4location) (clear ?2location) (at ?0player ?3location)
(not (at ?0player ?2location)) (not (clear ?4location)) (not (at ?1stone ?3location))))
...
(not (at-goal ?1stone)) (not (at ?0player ?2location)) (not (clear ?4location)) (not (at ?1stone ?3location))))
)
