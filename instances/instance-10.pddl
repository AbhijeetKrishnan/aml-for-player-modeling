...
(define (problem p137-microban-sequential)
  ...
  (:init
    ...
    (MOVE-DIR pos-13-10 pos-13-09 dir-up)
    (at player-01 pos-08-06)
    (at stone-01 pos-10-03)
    (at stone-02 pos-09-04)
    (at stone-03 pos-11-04)
    (at stone-04 pos-10-05)
    (clear pos-01-01)
    (clear pos-01-02)
    (clear pos-01-08)
    (clear pos-01-09)
